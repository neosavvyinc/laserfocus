...
export default class KCDetail extends Component {
        ...
        let items = [
            {
                name: 'Joe M',
                title: 'Sales Manager',
                statusDate: '9:30 AM,  27 Sep 2017',
                status: 'Changed the Project Status to Inputs In-Progress'
            },
            {
                name: 'Jane C',
                title: 'Marketing Manager',
                statusDate: '9:30 AM,  27 Sep 2017',
                status: 'Changed Sales Org to Both'
            },
            {
                name: 'Kurt S',
                title: 'Sales Supervisor',
                statusDate: '9:30 AM,  27 Sep 2017',
                status: 'Changed Customer to to National'
            },
            {
                name: 'Joe M',
                title: 'Sales Manager',
